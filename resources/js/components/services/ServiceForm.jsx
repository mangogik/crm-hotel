...
const Box = ({
    ...
    <div
        className={`rounded-lg border bg-white shadow-sm flex flex-col ${className}`}
    >
        {/* Header (TIDAK sticky) */}
        ...
        {/* Body (TIDAK scrollable/terbatas) */}
            ...
            <div className="pl-[2px]">
                {localError ? (
                    ...
                    <p className="text-[10px] text-muted-foreground leading-relaxed">
                        Guest will see this thumbnail when choosing the option.
                        Only one photo per option.
                    </p>
                )}
            </div>
        </div>
...
function OptionBlock({
    ...
    handleReplaceOptionImageSafe,
    optionImageErrors,
}) {
    // Use the option's key directly
        ...
        <div className="rounded-md border p-3 space-y-3">
            ...
            <div className="grid grid-cols-12 gap-2">
                <Input
                    ...
                    value={option.name}
                    onChange={(ev) =>
                        updateOption(index, "name", ev.target.value)
                    }
                ...
                <Input
                    ...
                    value={option.price}
                    onChange={(ev) =>
                        updateOption(index, "price", ev.target.value)
                    }
            ...
            <div className="text-xs text-gray-500">
                Option Key: {optionKey}, Existing Images: {existingArr.length}
            </div>
            ...
            <OptionImageRow
                ...
                localError={optionImageErrors[optionKey] || ""}
            />
            ...
            <div className="flex flex-col gap-1">
                ...
                {localError ? (
                    ...
                    <div className="text-[10px] text-muted-foreground leading-tight">
                        JPG / PNG / WebP • max 2MB each. You can remove them
                        here before saving.
                    </div>
                )}
            </div>
...
export default function ServiceForm({
    ...
    const aiConfig = {
        ...
        models: {
            custom: {
                ...
                wrapPayload: (message) => {
                    // backend terima { prompt: "..." }
                    return JSON.stringify({ prompt: message });
                },
                parseMessage: (message) => {
                    // Ini hanya untuk menampilkan hasil di bubble
                    try {
    ...
    return (
        // Layout utama: 1 kolom flex, dengan gap antar <Box>
        <div className="flex flex-col gap-6">
            {/* SECTION 1: BASICS & CONFIG (Dibungkus <Box>) */}
            <Box
                title="Basics & Configuration"
                subtitle={
                    typeHint || "Core details and placement in guest journey."
                }
            >
                <div className="space-y-6">
                    {/* BARIS 1: Grid untuk Name & Category */}
                    ...
                    {/* BARIS 2: Grid untuk Images & Config Lainnya */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* Kolom Kiri: Images */}
                        <Row
                            label="Images"
                        ...
                        >
                            <GeneralImagesPreview
                                ...
                                localError={galleryError}
                            />
                        </Row>

                        {/* Kolom Kanan: Sisa Config */}
                        <div className="space-y-3">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        <SelectItem value="pre_checkin">
                                            Pre Check-in
                                        </SelectItem>
                                        <SelectItem value="post_checkin">
                                            Post Check-in
                                        </SelectItem>
                                        <SelectItem value="pre_checkout">
                                            Pre Checkout
                                        </SelectItem>
                                    </SelectContent>
                                </Select>
                    ...
                    {/* BARIS 3: Full-width untuk AIEditor (Description) */}
                    <div>
                        <Label
                            htmlFor="description"
            ...
            {/* SECTION 2: PRICING / OPTIONS (Dibungkus <Box>) */}
            <Box
            ...
            {/* SECTION 3: CUSTOM QUESTIONS (Dibungkus <Box>) */}
            <Box
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="ml-2 group relative">
                            ...
                            <div className="absolute hidden group-hover:block z-10 w-64 p-2 mt-1 text-xs bg-black text-white rounded-md shadow-lg">
                                Customers will be asked these questions during
                                checkout.
                            </div>
                        </div>
                    </div>
