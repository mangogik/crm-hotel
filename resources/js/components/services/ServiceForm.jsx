      ...
      {data.type === "free" && (
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <div className="col-span-3 text-sm text-muted-foreground">
            This is a complimentary service. Price is fixed to <strong>0</strong>.
          </div>
        </div>
      )}
    </div>
