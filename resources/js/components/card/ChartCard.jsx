      ...
      <CardContent>
        <ChartContainer config={chartConfig}>
          <BarChart accessibilityLayer data={chartData}>
            ...
            <Bar dataKey="checkIns" fill="#fb923c" radius={4} />
            <Bar dataKey="servicesOrdered" fill="#60a5fa" radius={4} />
          </BarChart>
        </ChartContainer>
      </CardContent>
      <CardFooter className="flex-col items-start gap-2 text-sm">
        <div className="flex gap-2 leading-none font-medium">
          Trending naik 5.2% bulan ini <TrendingUp className="h-4 w-4" />
        </div>
        <div className="text-muted-foreground leading-none">
          Menampilkan total check-in dan layanan yang dipesan selama 7 hari terakhir
        </div>
      </CardFooter>
    </Card>
  )
